...
ggplot() +
  ...
  geom_raster(data = nlcd_df_forest, aes(x = x, y = y, fill = landcover)) +
  scale_fill_viridis_c(na.value = "transparent", name = "Land cover") +
  ...
  labs(title = "Historic Ivory-Billed Woodpecker Range in the US",
